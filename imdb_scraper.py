...
class ImdbscraperTop250:
    # engine = create_engine('postgresql://postgres:postgres@XX.XXX.53.140:5432/scrapers')
    ...
    def parse(self):
        ...
        for i in top250:
            ...
            self.results.append(
                {"rank": rank, "movie": name, "year": year, "rating": rating, "num_reviews": num_reviews}
            )
